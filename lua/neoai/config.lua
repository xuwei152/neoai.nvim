  ...
  return {
    ...
    shortcuts = {
      ...
      },
      {
        ...
        prompt = function()
          return [[
                        Write 1 commit messages that accurately summarizes the changes made in the given `git diff` output, following the conventional commit format. No markdown formatting!!! Don't output ```!!!
